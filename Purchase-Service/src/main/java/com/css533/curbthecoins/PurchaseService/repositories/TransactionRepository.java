...
public class TransactionRepository implements  ITransactionRepository{
    ...
    private static final String SQL_CREATE= "INSERT INTO CC_TRANSACTIONS (TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE) VALUES(NEXTVAL('CC_TRANSACTIONS_SEQ'),?,?,?,?,?)";
    private static final String SQL_FIND_BY_ID = " SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE FROM CC_TRANSACTIONS WHERE USER_ID IN (?,?) AND CATEGORY_ID = ? AND TRANSACTION_ID = ?";
    private static final String SQL_FIND_ALL = "SELECT TRANSACTION_ID, CATEGORY_ID, USER_ID, AMOUNT, NOTE, TRANSACTION_DATE FROM CC_TRANSACTIONS WHERE USER_ID IN (?, ?) AND CATEGORY_ID = ?";
    private static final String SQL_UPDATE = "UPDATE CC_TRANSACTIONS SET AMOUNT = ?, NOTE = ?, TRANSACTION_DATE = ?  WHERE USER_ID = ? AND CATEGORY_ID = ? AND TRANSACTION_ID = ? ";
    private static final String SQL_DELETE = "DELETE FROM CC_TRANSACTIONS WHERE USER_ID IN (? ,?) AND CATEGORY_ID = ? AND TRANSACTION_ID = ? ";
    ...
    public Transaction findById(Integer userId, Integer partnerId, Integer categoryId, Integer transactionId) throws CCResourceNotFoundException {
        try{
            ...
            throw new CCResourceNotFoundException("Transaction Not found");
        }
    }
